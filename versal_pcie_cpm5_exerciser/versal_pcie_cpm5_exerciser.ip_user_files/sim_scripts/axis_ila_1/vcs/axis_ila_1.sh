...
design_libs=(xilinx_vip xpm axis_dbg_stub_v1_0_0 xil_defaultlib xlconstant_v1_1_7 axis_dbg_sync_v1_0_0 axis_ila_intf_v1_0_0 axis_cap_ctrl_v1_0_0 axis_mu_v1_0_0 axis_itct_v1_0_0 axis_ila_pp_v1_0_0 axis_mem_v1_0_0)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_dbg_stub_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_dbg_stub_v1_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../versal_pcie_cpm5_exerciser.gen/sources_1/ip/axis_ila_1/bd_0/ip/ip_0/sim/bd_f030_0_axis_dbg_stub_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_dbg_sync_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_dbg_sync_v1_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axis_ila_intf_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_cap_ctrl_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_mu_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_itct_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_ila_pp_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  vlogan -work axis_mem_v1_0_0 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_ila_1 xil_defaultlib.glbl -o axis_ila_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_ila_1_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/root/xuguo/xilinx_pro/vpk120/versal_pcie_cpm5_exerciser/versal_pcie_cpm5_exerciser.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axis_ila_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_ila_1_simv.daidir vcs_lib c.obj)
