...
#
# Script generated by Vivado on Wed Jan 03 15:47:21 CST 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : axis_ila_1.sh
...
#
# Usage        : axis_ila_1.sh
#                axis_ila_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_ila_1.sh [-reset_run]
#                axis_ila_1.sh [-reset_log]
#                axis_ila_1.sh [-help]
#
...
#                script (type 'axis_ila_1.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axis_dbg_stub_v1_0_0 -libname xil_defaultlib -libname xlconstant_v1_1_7 -libname axis_dbg_sync_v1_0_0 -libname axis_ila_intf_v1_0_0 -libname axis_cap_ctrl_v1_0_0 -libname axis_mu_v1_0_0 -libname axis_itct_v1_0_0 -libname axis_ila_pp_v1_0_0 -libname axis_mem_v1_0_0 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axis_dbg_stub_v1_0_0 xil_defaultlib xlconstant_v1_1_7 axis_dbg_sync_v1_0_0 axis_ila_intf_v1_0_0 axis_cap_ctrl_v1_0_0 axis_mu_v1_0_0 axis_itct_v1_0_0 axis_ila_pp_v1_0_0 axis_mem_v1_0_0)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_ila_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_ila_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_dbg_stub_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_dbg_stub_v1_0_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../../versal_pcie_cpm5_exerciser.gen/sources_1/ip/axis_ila_1/bd_0/ip/ip_0/sim/bd_f030_0_axis_dbg_stub_0.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xlconstant_v1_1_7 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_dbg_sync_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_dbg_sync_v1_0_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axis_ila_intf_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_cap_ctrl_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_mu_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_itct_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_ila_pp_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_mem_v1_0_0 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl/verilog" +incdir+"../../../ipstatic/hdl/verilog" +incdir+"/tools/Xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_ila_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_ila_1 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/root/xuguo/xilinx_pro/vpk120/versal_pcie_cpm5_exerciser/versal_pcie_cpm5_exerciser.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_ila_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_ila_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_ila_1.sh [-help]\n\
Usage: axis_ila_1.sh [-step]\n\
Usage: axis_ila_1.sh [-lib_map_path]\n\
Usage: axis_ila_1.sh [-reset_run]\n\
Usage: axis_ila_1.sh [-reset_log]\n\
Usage: axis_ila_1.sh [-keep_index]\n\
Usage: axis_ila_1.sh [-noclean_files]\n\n\
