...
# set xvlog options
xvlog_opts="--incr --relax  -L cpm5_v1_0_12 -L cpm4_v1_0_12 -L axi_vip_v1_1_14 -L smartconnect_v1_0 -L versal_cips_ps_vip_v1_0_6 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axis_dbg_stub_v1_0_0 -L xil_defaultlib -L xlconstant_v1_1_7 -L axis_dbg_sync_v1_0_0 -L axis_ila_intf_v1_0_0 -L axis_cap_ctrl_v1_0_0 -L axis_mu_v1_0_0 -L axis_itct_v1_0_0 -L axis_ila_pp_v1_0_0 -L axis_mem_v1_0_0 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_ila_1 xil_defaultlib.axis_ila_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_ila_1 -key {Behavioral:sim_1:Functional:axis_ila_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6f6a.protoinst" -protoinst "protoinst_files/exerciser.protoinst" -protoinst "protoinst_files/bd_f030_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_ila_1.wdb xsim.dir libdpi.so)
