...
assign mcap_clk1 = (C_CPM_PCIE1_USER_CLK_FREQ == "500_MHz" || C_CPM_PCIE1_USER_CLK_FREQ == "250_MHz" || C_CPM_PCIE1_USER_CLK_FREQ == "125_MHz") ? clk_125 : user_clk;
assign pipe_clk_fr1 = (tx1_rate_comm[2]  == 1'b1)? clk_1000 :
                     (tx1_rate_comm[1:0] == 2'b0)? clk_125 : 
                     (tx1_rate_comm[1:0] == 2'b1)? clk_250 :
                                                  clk_500; // G1 = 125; G2 = 250; G3/G4 = 500; G5 = 1000;

// pipe_clk assigned at the wires file
assign core_clk1 = (C_CPM_PCIE1_CORE_CLK_FREQ == "1000_MHz") ? clk_1000 :
                  (C_CPM_PCIE1_CORE_CLK_FREQ == "500_MHz")  ? clk_500  :
                                                              clk_250;
                                                              
assign user_clk1 = (C_CPM_PCIE1_USER_CLK_FREQ == "500_MHz") ? clk_500 :
                  (C_CPM_PCIE1_USER_CLK_FREQ == "250_MHz") ? clk_250 :
                  (C_CPM_PCIE1_USER_CLK_FREQ == "125_MHz") ? clk_125 :
                                                             clk_62_5;
...
begin
  assign txout_clk1   = clk_1000;
  assign pipeclk_div1 = (tx_rate_comm[2]  == 1'b1)? 'd0 :
...
begin
  assign txout_clk1   = clk_500;
  assign pipeclk_div1 = (tx_rate_comm[1:0] == 2'b0)? 'd3 : 
...
begin
  assign txout_clk1   = clk_250;
  assign pipeclk_div1 = (tx_rate_comm[1:0] == 2'b0)? 'd1 : 
                                                           'd0; // G1 = 125; G2 = 250; G3/G4 = 500; G5 = 1000;
  assign coreclk_div1 = 0; // Coreclk = TXoutclk
...
begin
  if (phy_rdy_reg1[16] == 1'b0) begin
    ...
    case (bufggt_rst_sm1)
      BUFGGT_SM_IDLE1 : bufggt_rst_sm <= (rate_change) ? BUFGGT_SM_CEN1 : BUFGGT_SM_IDLE1;
      BUFGGT_SM_CEN1  : bufggt_rst_sm <= BUFGGT_SM_RST1;
      BUFGGT_SM_RST1  : bufggt_rst_sm <= BUFGGT_SM_CE1;
      BUFGGT_SM_CE1   : bufggt_rst_sm <= BUFGGT_SM_IDLE1;
      default        : bufggt_rst_sm <= BUFGGT_SM_IDLE1;
    endcase
  end
end
...
assign local_pipe_clk1 = pipe_clk;
