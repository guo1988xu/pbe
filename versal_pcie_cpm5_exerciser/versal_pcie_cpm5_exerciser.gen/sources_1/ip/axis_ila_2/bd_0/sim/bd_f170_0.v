...
//--------------------------------------------------------------------------------
//Command: generate_target bd_f170_0.bd
//Design : bd_f170_0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_f170_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_f170_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=31,numReposBlks=31,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "axis_ila_2.hwdef" *) 
module bd_f170_0
   (clk,
    probe0,
    probe1,
    ...
    probe8,
    probe9);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN bd_f170_0_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE0, LAYERED_METADATA undef" *) input [0:0]probe0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE1, LAYERED_METADATA undef" *) input [1023:0]probe1;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE10 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE10, LAYERED_METADATA undef" *) input [15:0]probe10;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE12 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE12, LAYERED_METADATA undef" *) input [31:0]probe12;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE13 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE13, LAYERED_METADATA undef" *) input [0:0]probe13;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE2 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE2, LAYERED_METADATA undef" *) input [448:0]probe2;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE3 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE3, LAYERED_METADATA undef" *) input [31:0]probe3;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE4 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE4, LAYERED_METADATA undef" *) input [0:0]probe4;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE6 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE6, LAYERED_METADATA undef" *) input [15:0]probe6;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE7 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE7, LAYERED_METADATA undef" *) input [15:0]probe7;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE8 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE8, LAYERED_METADATA undef" *) input [26:0]probe8;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE9 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE9, LAYERED_METADATA undef" *) input [15:0]probe9;
  ...
  wire [0:0]axis_ila_pp_probe0_out;
  wire [15:0]axis_ila_pp_probe10_out;
  wire [31:0]axis_ila_pp_probe11_out;
  wire [31:0]axis_ila_pp_probe12_out;
  wire [0:0]axis_ila_pp_probe13_out;
  wire [1023:0]axis_ila_pp_probe1_out;
  wire [448:0]axis_ila_pp_probe2_out;
  wire [31:0]axis_ila_pp_probe3_out;
  wire [0:0]axis_ila_pp_probe4_out;
  wire [0:0]axis_ila_pp_probe5_out;
  wire [15:0]axis_ila_pp_probe6_out;
  wire [15:0]axis_ila_pp_probe7_out;
  wire [26:0]axis_ila_pp_probe8_out;
  wire [15:0]axis_ila_pp_probe9_out;
  ...
  wire [15:0]axis_mem_trace_rd_wrd_cnt_o;
  ...
  assign probe8_1 = probe8[26:0];
  assign probe9_1 = probe9[15:0];
  bd_f170_0_axis_cap_ctrl_0 axis_cap_ctrl
  ...
  bd_f170_0_axis_dbg_stub_0 axis_dbg_stub
  ...
  bd_f170_0_axis_ila_pp_0 axis_ila_pp
       (.clk(clk_1),
        .probe0(probe0_1),
  ...
  bd_f170_0_axis_itct_0 axis_itct
  ...
  bd_f170_0_axis_mu0_0_0 axis_mu0_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu10_0_0 axis_mu10_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu11_0_0 axis_mu11_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu12_0_0 axis_mu12_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu13_0_0 axis_mu13_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu1_0_0 axis_mu1_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu2_0_0 axis_mu2_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu3_0_0 axis_mu3_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu4_0_0 axis_mu4_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu5_0_0 axis_mu5_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu6_0_0 axis_mu6_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu7_0_0 axis_mu7_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu8_0_0 axis_mu8_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_axis_mu9_0_0 axis_mu9_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_cc_axis_mu0_0 cc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_cc_axis_mu1_0 cc_axis_mu1
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_cc_axis_mu2_0 cc_axis_mu2
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_cc_axis_mu3_0 cc_axis_mu3
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_tc_axis_mu0_0 tc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_f170_0_xlconstant_0 xlconstant
