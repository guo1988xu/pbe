...
(* CORE_GENERATION_INFO = "bd_30f1_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_30f1_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=24,numReposBlks=24,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "axis_ila_0.hwdef" *) 
module bd_30f1_0
   (clk,
    probe0,
    probe1,
    ...
    probe5,
    probe6);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN bd_30f1_0_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE0, LAYERED_METADATA undef" *) input [31:0]probe0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE1 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE1, LAYERED_METADATA undef" *) input [31:0]probe1;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.PROBE3 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.PROBE3, LAYERED_METADATA undef" *) input [0:0]probe3;
  ...
  wire [31:0]axis_ila_pp_probe0_out;
  wire [31:0]axis_ila_pp_probe1_out;
  wire [0:0]axis_ila_pp_probe2_out;
  wire [0:0]axis_ila_pp_probe3_out;
  ...
  wire [6:0]axis_itct_trigger_din;
  ...
  wire [11:0]axis_mem_trace_rd_wrd_cnt_o;
  ...
  bd_30f1_0_axis_cap_ctrl_0 axis_cap_ctrl
  ...
  bd_30f1_0_axis_dbg_stub_0 axis_dbg_stub
  ...
  bd_30f1_0_axis_ila_pp_0 axis_ila_pp
       (.clk(clk_1),
        .probe0(probe0_1),
  ...
  bd_30f1_0_axis_itct_0 axis_itct
  ...
  bd_30f1_0_axis_mu0_0_0 axis_mu0_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu1_0_0 axis_mu1_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu2_0_0 axis_mu2_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu3_0_0 axis_mu3_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu4_0_0 axis_mu4_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu5_0_0 axis_mu5_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_axis_mu6_0_0 axis_mu6_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_cc_axis_mu0_0 cc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_cc_axis_mu1_0 cc_axis_mu1
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_cc_axis_mu2_0 cc_axis_mu2
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_cc_axis_mu3_0 cc_axis_mu3
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_tc_axis_mu0_0 tc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_30f1_0_xlconstant_0 xlconstant
