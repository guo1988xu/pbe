...
//Command     : generate_target cpm_pcie_pio_wrapper.bd
//Design      : cpm_pcie_exerciser_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module cpm_pcie_exerciser_wrapper
(gt_refclk1_0_clk_n,
 gt_refclk1_0_clk_p,
 PCIE1_GT_0_grx_n,
 PCIE1_GT_0_grx_p,
 ...
 PCIE1_GT_0_gtx_p
  ...
  input [15:0]				        PCIE1_GT_0_grx_n;
  input [15:0]                      PCIE1_GT_0_grx_p;
  output [15:0]                     PCIE1_GT_0_gtx_n;
  output [15:0]                     PCIE1_GT_0_gtx_p;
  ...
  wire [KEEP_WIDTH-1:0]             pcie1_m_axis_rc_0_tkeep;
  ...
  wire cfg_interrupt_msi_vf_enable;
  ...
  wire [KEEP_WIDTH-1:0]             pcie1_s_axis_rq_0_tkeep;
...
//------------------------------------------------------------------------------------------------------------------//
//                                      EXERCISER Design Top Level                                                //
//------------------------------------------------------------------------------------------------------------------//



pcie_app_versal_exerciser #(
    .C_DATA_WIDTH                                   (1024 ),
 ...
 //   .pcie_tfc_nph_av                              ( pcie1_transmit_fc_0_nph_av[1:0]),
  //  .pcie_tfc_npd_av                              ( pcie1_transmit_fc_0_npd_av[1:0]),
    ...
    .cfg_flr_in_process                             ( pcie1_cfg_control_0_flr_in_process [3:0] ),
...
/*
	.cfg_interrupt_msix_enable                      (pcie1_cfg_msix_0_enable),
	.cfg_interrupt_msix_mask                        (pcie1_cfg_msix_0_mask),
	.cfg_interrupt_msix_fail                        (pcie1_cfg_msix_0_fail),
