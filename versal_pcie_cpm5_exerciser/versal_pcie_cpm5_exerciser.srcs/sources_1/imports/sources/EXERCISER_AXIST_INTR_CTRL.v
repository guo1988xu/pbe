...
module EXERCISER_AXIST_INTR_CTRL#(
       parameter        TCQ = 1
)(
...
/*
axis_ila_0 interrupt (
  .clk(user_clk),        // input wire clk
  .probe0(cfg_interrupt_msi_enable),  // input wire [3 : 0] probe0
  .probe1(cfg_interrupt_msi_sent),  // input wire [0 : 0] probe1
  .probe2(cfg_interrupt_msi_fail),  // input wire [0 : 0] probe2
  .probe3(cfg_interrupt_msi_int),  // input wire [31 : 0] probe3
  .probe4(cfg_interrupt_msi_function_number),  // input wire [7 : 0] probe4
  .probe5(cfg_interrupt_msi_select),  // input wire [1 : 0] probe5
  .probe6(r_rd_done),  // input wire [0 : 0] probe6
  .probe7(r_wr_done),  // input wire [0 : 0] probe7
  .probe8(r_keep),  // input wire [0 : 0] probe8
  .probe9(counter)  // input wire [3 : 0] probe9
);
 */
/*
