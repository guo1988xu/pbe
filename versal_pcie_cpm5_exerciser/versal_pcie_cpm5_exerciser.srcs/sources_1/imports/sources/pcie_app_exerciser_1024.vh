...
// under the License.
// ////////////////////////////////////////////////////////////////////////
`ifndef PCIE_APP_USCALE_EXERCISER_H
`define PCIE_APP_USCALE_EXERCISER_H
...
`define EXERCISERREG(clk, reset_n, q, d, rstval)  \
...
`define AS_EXERCISERREG(clk, reset_n, q, d, rstval)  \
...
`else    // PCIE_APP_USCALE_EXERCISER_H
`endif   // PCIE_APP_USCALE_EXERCISER_H
